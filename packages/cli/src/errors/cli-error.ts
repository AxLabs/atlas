...
export const CliErrorCode = {
  ...
  UPGRADE_PREREQUISITE: "UPGRADE_PREREQUISITE",
...
const EXIT_CODE_BY_CLI_ERROR: Record<CliErrorCode, ExitCode> = {
  ...
  [CliErrorCode.GENERATOR_CONFLICT]: ExitCode.GENERATOR_CONFLICT,
  [CliErrorCode.PREREQUISITE_ERROR]: ExitCode.PREREQUISITE_ERROR,
  [CliErrorCode.UPGRADE_BLOCKED]: ExitCode.UPGRADE_BLOCKED,
  [CliErrorCode.UPGRADE_PREREQUISITE]: ExitCode.UPGRADE_PREREQUISITE,
