...
describe("historical upgrade rehearsal", () => {
  ...
  const plan = planUpgrade({
    ...
    baselineChecksums,
    sourceSyncedPaths: METADATA.rehearsalManifestSubset.syncedPaths,
    sourceGeneratedPaths: METADATA.rehearsalManifestSubset.generatedPaths,
    sourceIndependentPaths: METADATA.rehearsalManifestSubset.independentPaths,
