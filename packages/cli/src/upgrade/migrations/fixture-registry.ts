...
import type { MigrationContext, MigrationRunResult } from "./types";
...
/** Test/fixture migration registry — never used for real consumer upgrades unless explicitly injected. */
