...
function copyWorkflow(filename) {
  ...
  if (fs.existsSync(dest)) {
    console.log(`Workflow already exists: ${filename} (skipped)`);
    return true;
  }
...
function main() {
  ...
  if (success) {
    console.log("\nPerformance budgets module enabled.\n");
    ...
    console.log("4. Commit the new workflows to enable checks in CI\n");
    console.log("See docs/_archive/2025-12-pre-platform-docs/performance-budgets.md for details.");
  } else {
