...
| [Consumer tooling](consumer-tooling.md)               | Default vs opt-in quality tooling for generated apps      |
| [Reference patterns](reference-patterns.md)           | Settings, CRUD, and diagnostics without the reference app |
