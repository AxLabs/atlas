...
| C-022 | Release automation publishes GitHub Releases after Version PR merge | `.github/workflows/release.yml`, `scripts/publish-atlas-release.mjs`                   | Maintainers          | —                   | CI                        | Fail-closed `publish-atlas-release`; npm job uses OIDC after GitHub Release; no changesets npm `publish:`; no `continue-on-error`                    | qualified | First npm version is canonical `1.0.0` from tag `v1.0.0`; OIDC provenance applies to later publishes; package is not on the registry yet  | [releases-and-governance.md](../how-we-build/releases-and-governance.md) | @thedanielmark | 2026-09-17    | 2026-11-16  |
| C-023 | GitHub Release exists for current Atlas version                     | GitHub Releases UI                                                                     | Public               | —                   | Release artifact          | Canonical `v0.5.0` GitHub Release exists; next public distribution is `1.0.0`                                                                        | proven    | npm package is not published yet; `pnpm dlx @blitzcraftlabs/atlas` is not live; do not bootstrap npm with 0.5.0                           | [releases-and-governance.md](../how-we-build/releases-and-governance.md) | @thedanielmark | 2026-09-17    | 2026-11-16  |
