...
| C-023 | GitHub Release exists for current Atlas version                     | GitHub Releases UI                                                                     | Public               | —                   | Release artifact          | Canonical `v1.0.0` GitHub Release exists; first npm registry version is `1.0.1`                                                                                                                                                          | proven    | `@blitzcraftlabs/atlas@1.0.1` is the first npm-published release; do not bootstrap npm with 0.5.0 or 1.0.0; never retag v1.0.0        | [releases-and-governance.md](../how-we-build/releases-and-governance.md) | @thedanielmark | 2026-09-19    | 2026-11-16  |
