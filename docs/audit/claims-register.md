...
| C-014 | Security audit fails CI on HIGH/CRITICAL vulnerabilities            | `.github/workflows/security-audit.yml`, `pnpm security:check`                          | Engineers            | Secure              | CI                        | Atlas policy evaluator; HIGH fixture fails; moderate is reported non-blocking                                                                                                                                                            | proven    | `pnpm audit` is not complete application security; GitHub CodeQL is separate GitHub-native scanning and not this merge gate    | [security.md](../how-we-build/security.md)                               | @thedanielmark | 2026-09-23    | 2026-11-16  |
...
| C-026 | GitHub CodeQL default setup is configured on the canonical repo     | `docs/how-we-build/security.md`, `docs/how-we-build/repository-integrations.md`        | Engineers            | Secure              | GitHub repository setting | `GET /repos/blitzcraftlabs/atlas/code-scanning/default-setup` → `configured` (inspected 2026-09-23); dynamic workflow `dynamic/github-code-scanning/codeql`; no in-repo CodeQL workflow file                                             | qualified | Not a required status check; not shipped to `atlas init` consumers; does not replace Secrets Scan or Security Audit            | [security.md](../how-we-build/security.md)                               | @thedanielmark | 2026-09-23    | 2026-11-16  |
| C-027 | GitHub Code Quality is a distinct product and is not configured     | `docs/how-we-build/security.md`, `docs/how-we-build/repository-integrations.md`        | Engineers            | —                   | GitHub repository setting | `GET /repos/blitzcraftlabs/atlas/code-quality/setup` → `state: not-configured`; findings API 403; no `github-code-quality` workflow runs (inspected 2026-09-23)                                                                          | proven    | Distinct from CodeQL security scanning and from Atlas UI Quality; not a merge gate                                             | [repository-integrations.md](../how-we-build/repository-integrations.md) | @thedanielmark | 2026-09-23    | 2026-11-16  |
