...
| C-003 | Atlas is MIT-licensed                               | Former `README.md` License section                                              | Public                 | —                   | License file              | No root `LICENSE`; GitHub shows no license                                           | remove    | Licensing unresolved                                                                  | [#19](https://github.com/blitzcraftlabs/atlas/issues/19)                        | @thedanielmark | 2026-08-16    | 2026-11-16  |
