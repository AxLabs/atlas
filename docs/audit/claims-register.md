...
from independent review, certification, and consumer-specific obligations
([#18](https://github.com/blitzcraftlabs/atlas/issues/18),
...
| C-003 | Atlas is MIT-licensed                                    | Former `README.md` License section                                              | Public                 | —                   | License file              | Root [`LICENSE`](../../LICENSE) is Apache-2.0; package metadata uses Apache-2.0      | remove    | Historical README wording was incorrect/superseded                          | [#24](https://github.com/blitzcraftlabs/atlas/issues/24) only if public GitHub license detection is relevant | @thedanielmark | 2026-08-20    | 2026-11-16  |
...
| C-006 | Accessibility violations cause build errors              | `docs/public/capabilities.md`, `docs/public/decisions.md`, `docs/public/faq.md` | Evaluators             | Accessible          | CI + lint config          | ESLint jsx-a11y errors; Storybook axe on `critical` stories in UI Quality workflow   | qualified | ESLint + representative Storybook axe; not full WCAG or every story         | —                                                                                                            | @thedanielmark | 2026-08-29    | 2026-11-16  |
| C-007 | High unit-test coverage across the platform              | Former `docs/public/faq.md` testing section                                     | Evaluators             | Production-ready    | Test inventory            | Risk-based subsystem floors via `pnpm test:risk-coverage`; not repo-wide 80%         | qualified | Codecov is reporting; local coverage policy is the blocking gate            | [#12](https://github.com/blitzcraftlabs/atlas/issues/12)                                                     | @thedanielmark | 2026-08-29    | 2026-11-16  |
...
| C-013 | CI enforces critical subsystem coverage                  | `.github/workflows/ci.yml` “Enforce critical subsystem coverage”                | Engineers              | Production-ready    | CI                        | `pnpm test:risk-coverage` + `coverage-policy.json`                                   | proven    | Codecov upload is non-blocking reporting                                    | [#12](https://github.com/blitzcraftlabs/atlas/issues/12)                                                     | @thedanielmark | 2026-08-29    | 2026-11-16  |
